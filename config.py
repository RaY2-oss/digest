...
COVERAGE_FULL_AT = 12        # столько изданий = полный вес фактора охвата
IMPORTANCE_W_LEXRANK = 0.20
IMPORTANCE_W_COVERAGE = 0.30
IMPORTANCE_W_ENTITY = 0.15   # 0.0 — выключить фактор, не трогая код
IMPORTANCE_W_TOPIC = 0.35
