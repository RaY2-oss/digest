...
ENTITY_WEIGHT = 0.35   # доля фактора в итоговой важности; 0.0 — выключить.
                        # Автоматически игнорируется, пока в корпусе нет ни
                        # одного заметного субъекта (старые строки без entities).
