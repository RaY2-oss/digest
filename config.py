...
# общей загрузке, а достаётся отдельным проходом тем URL, у которых обычный
# запрос текста не забрал (см. daily_collector.rescue_with_browser). Замер на
# сотне таких адресов: requests 23, curl_cffi 23, camoufox 32 из 100. Потолок
