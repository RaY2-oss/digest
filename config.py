...
# пересказ по нескольким версиям полнее, чем по одной. Потолки держат
# промпт в пределах контекста бесплатных моделей — за ними начинаются
# галлюцинации и обрывы JSON.
RETELL_MAX_VERSIONS = 4
RETELL_CHARS_PER_VERSION = 3000
